const landing = new Vue({
    ...
    data: {
	 ...
	 description:'Charlie, a young boy from an impoverished family,'+
                  'and four other kids win a tour of an amazing chocolate factory run by an imaginative chocolatier,' 
                   +'Willy Wonka, and his staff of Oompa-Loompas.',
	poster:'https://www.famousbirthdays.com/group_images/medium/charlie-chocolate-factory-movie.jpg',
